package com.fernando.springboot.shop.api.shop.modules.product.v2.dto;
...
public class ProductBodyDtoV2 {
    ...
    @NotEmpty(message = "El producto debe tener al menos una categoria", groups = {OnCreate.class})
    public Set<@NotNull(message = "La categoria debe ser un entero", groups = {OnCreate.class, OnUpdate.class}) Long> categoriesId;
